# Tennessee Commercial Source Playbook

Read this file before refreshing `data/states/tn.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** TN (Tennessee)  
**Corpus file:** `data/states/tn.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 4  
**Counties:** 4 · **Cities:** 4  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — REBusinessOnline, permit filings, local news.  
...
- Generic ArcGIS Hub search without verifying the layer covers Tennessee.
