# Texas Commercial Source Playbook

Read this file before refreshing `data/states/tx.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** TX (Texas)  
**Corpus file:** `data/states/tx.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 5  
**Counties:** 5 · **Cities:** 5  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — REBusinessOnline, BLDUP, state/local announcements. No proprietary plan-room data.  
**Status mix:** planning 3, under_construction 2
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers Texas.
