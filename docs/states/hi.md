# Hawaii Commercial Source Playbook

Read this file before refreshing `data/states/hi.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** HI (Hawaii)  
**Corpus file:** `data/states/hi.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 2  
**Counties:** 1 · **Cities:** 2  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — CNR Magazine, Star-Advertiser, EB5 updates.  
**Status mix:** under_construction 1, planning 1
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers Hawaii.
