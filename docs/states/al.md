# Alabama Commercial Source Playbook

Read this file before refreshing `data/states/al.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** AL (Alabama)  
**Corpus file:** `data/states/al.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 8  
**Counties:** 6 · **Cities:** 7  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Web research — governor.alabama.gov, Made in Alabama, al.com, local TV news, ADECA  
**Status mix:** planning 5, under_construction 3
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers Alabama.
