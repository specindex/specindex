# Montana Commercial Source Playbook

Read this file before refreshing `data/states/mt.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** MT (Montana)  
**Corpus file:** `data/states/mt.json`  
...
- Generic ArcGIS Hub search without verifying the layer covers Montana.
