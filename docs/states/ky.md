# Kentucky Commercial Source Playbook

Read this file before refreshing `data/states/ky.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** KY (Kentucky)  
**Corpus file:** `data/states/ky.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 2  
**Counties:** 2 · **Cities:** 2  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — local news, permit filings.  
...
- Generic ArcGIS Hub search without verifying the layer covers Kentucky.
