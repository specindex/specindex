# North Carolina Commercial Source Playbook

Read this file before refreshing `data/states/nc.json`. Keep it current so the next pull starts from what already worked.
...
**Capture method:** Public sources — AbbVie press release, local news, industry publications.  
...
- Generic ArcGIS Hub search without verifying the layer covers North Carolina.
