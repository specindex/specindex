# Massachusetts Commercial Source Playbook

Read this file before refreshing `data/states/ma.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** MA (Massachusetts)  
**Corpus file:** `data/states/ma.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 2  
**Counties:** 2 · **Cities:** 2  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — REBusinessOnline, local industrial news.  
...
- Generic ArcGIS Hub search without verifying the layer covers Massachusetts.
