# Oregon Commercial Source Playbook

Read this file before refreshing `data/states/or.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** OR (Oregon)  
**Corpus file:** `data/states/or.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 5  
**Counties:** 5 · **Cities:** 5  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — PR Newswire, Data Center Dynamics, local permits, trade publications.  
...
- Generic ArcGIS Hub search without verifying the layer covers Oregon.
