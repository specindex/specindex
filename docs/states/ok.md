# Oklahoma Commercial Source Playbook

Read this file before refreshing `data/states/ok.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** OK (Oklahoma)  
**Corpus file:** `data/states/ok.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 4  
**Counties:** 3 · **Cities:** 4  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — state economic development, industry news, city announcements.  
...
- Generic ArcGIS Hub search without verifying the layer covers Oklahoma.
