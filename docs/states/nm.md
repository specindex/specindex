# New Mexico Commercial Source Playbook

Read this file before refreshing `data/states/nm.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** NM (New Mexico)  
**Corpus file:** `data/states/nm.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 1  
**Counties:** 1 · **Cities:** 1  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — DCD, Stargate announcements.  
...
- Generic ArcGIS Hub search without verifying the layer covers New Mexico.
