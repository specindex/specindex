# Arizona Commercial Source Playbook

Read this file before refreshing `data/states/az.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** AZ (Arizona)  
**Corpus file:** `data/states/az.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 7  
**Counties:** 2 · **Cities:** 6  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Web research — Prime Data Centers, AZ Big Media, REBusinessOnline, Colliers, Connect CRE, Hoodline  
**Status mix:** under_construction 6, planning 1
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers Arizona.
...
|------|--------------|---------|
| 2026-07-24 | Stub synced from corpus | 7 projects |
