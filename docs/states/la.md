# Louisiana Commercial Source Playbook

Read this file before refreshing `data/states/la.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** LA (Louisiana)  
**Corpus file:** `data/states/la.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 1  
**Counties:** 1 · **Cities:** 1  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — Meta Data Centers, WWNO, state economic development.  
...
- Generic ArcGIS Hub search without verifying the layer covers Louisiana.
