# Alaska Commercial Source Playbook

Read this file before refreshing `data/states/ak.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** AK (Alaska)  
**Corpus file:** `data/states/ak.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 5  
**Counties:** 3 · **Cities:** 3  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Web research — Alaska Business Magazine, ADN, PR Newswire, Tanana Chiefs Conference, DredgeWire  
...
- Generic ArcGIS Hub search without verifying the layer covers Alaska.
