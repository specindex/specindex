# Idaho Commercial Source Playbook

Read this file before refreshing `data/states/id.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** ID (Idaho)  
**Corpus file:** `data/states/id.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 3  
**Counties:** 1 · **Cities:** 2  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — Idaho Statesman, BoiseDev, PR Newswire.  
...
- Generic ArcGIS Hub search without verifying the layer covers Idaho.
