# South Carolina Commercial Source Playbook

Read this file before refreshing `data/states/sc.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** SC (South Carolina)  
**Corpus file:** `data/states/sc.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 4  
**Counties:** 4 · **Cities:** 4  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — SC Dept of Commerce, local business journals, press releases.  
...
- Generic ArcGIS Hub search without verifying the layer covers South Carolina.
