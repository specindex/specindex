# California Commercial Source Playbook

Read this file before refreshing `data/states/ca.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** CA (California)  
**Corpus file:** `data/states/ca.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 12  
**Counties:** 11 · **Cities:** 12  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Web research — DCD, Prime Data Centers, REBusinessOnline, DataBank, Daily Bulletin, Deli Market News, Patch  
**Status mix:** under_construction 10, planning 2
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers California.
...
|------|--------------|---------|
| 2026-07-24 | Stub synced from corpus | 12 projects |
