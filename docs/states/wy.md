# Wyoming Commercial Source Playbook

Read this file before refreshing `data/states/wy.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** WY (Wyoming)  
**Corpus file:** `data/states/wy.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 5  
**Counties:** 2 · **Cities:** 2  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — Cap City News, Cowboy State Daily, Wyoming News, county planning filings.  
**Status mix:** permitting 3, planning 1, under_construction 1
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers Wyoming.
