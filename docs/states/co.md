# Colorado Commercial Source Playbook

Read this file before refreshing `data/states/co.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** CO (Colorado)  
**Corpus file:** `data/states/co.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 7  
**Counties:** 6 · **Cities:** 7  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Web research — Mile High CRE, Connect CRE, BusinessDen, Caliber, Construction Review Online, ENR  
**Status mix:** under_construction 7
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers Colorado.
