# West Virginia Commercial Source Playbook

Read this file before refreshing `data/states/wv.json`. Keep it current so the next pull starts from what already worked.

<!-- AUTO:HEADER START -->
**State:** WV (West Virginia)  
**Corpus file:** `data/states/wv.json`  
**Last corpus update:** 2026-07-24  
**Projects in corpus:** 4  
**Counties:** 4 · **Cities:** 4  
**Date range:** 2026-04-26 to 2026-07-24 (last 90 days)  
**Capture method:** Public sources — My Buckhannon, West Virginia Daily News, Lede News, state economic development.  
**Status mix:** under_construction 4
<!-- AUTO:HEADER END -->
...
- Generic ArcGIS Hub search without verifying the layer covers West Virginia.
